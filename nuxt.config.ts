...
export default defineNuxtConfig({
    ...
    plugins: ['~/plugins/custom-type', '~/plugins/services/index'],
    ssr: false,
    ...
    runtimeConfig: {
        ...
        public: {
            search: {
                ...
                indices: {
                    persons:
                        process.env.NUXT_PUBLIC_SEARCH_INDICES_PERSONS || '',
                    sponsors:
                        process.env.NUXT_PUBLIC_SEARCH_INDICES_SPONSORS || '',
                    modules:
                        process.env.NUXT_PUBLIC_SEARCH_INDICES_MODULES || '',
                    categories:
                        process.env.NUXT_PUBLIC_SEARCH_INDICES_CATEGORIES || '',
                },
            },
        },
        routeRules: {
            ...
            '/typesense/**': {
                proxy: 'http://typesense.localhost:9080/**',
            },
        },
        sourcemap: {
            server: true,
        ...
        nitro: {
            devProxy: {
                '/typesense': {
                    target: 'http://typesense.localhost:9080',
                    changeOrigin: true,
                },
            },
            prerender: {
